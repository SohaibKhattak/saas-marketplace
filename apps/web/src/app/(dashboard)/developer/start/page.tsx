  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-1.5 text-sm text-gray-500">
        ...
        <span className="text-foreground font-semibold tracking-tight">Start Building</span>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-5xl mx-auto">
        ...
        <Card className="relative overflow-hidden border-2 hover:border-primary/50 transition-all group">
          <div className="absolute top-4 right-4">
            <Badge className="bg-white0/10 text-neutral-900 dark:text-blue-400 border-gray-200/20">
              Full Control
            </Badge>
          </div>
          <CardHeader className="pb-4">
            <div className="flex h-14 w-14 items-center justify-center rounded-sm bg-gradient-to-br from-blue-500/20 to-purple-500/20 mb-2">
              <Code2 className="h-7 w-7 text-neutral-900" />
            </div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1.5 rounded-sm bg-muted px-3 py-1.5">
                ...
                <span className="text-xs font-semibold tracking-tight">Node.js</span>
              </div>
              <div className="flex items-center gap-1.5 rounded-sm bg-muted px-3 py-1.5">
                <Layers className="h-3.5 w-3.5 text-neutral-900" />
                <span className="text-xs font-semibold tracking-tight">React</span>
              </div>
              <div className="flex items-center gap-1.5 rounded-sm bg-muted px-3 py-1.5">
                <Zap className="h-3.5 w-3.5 text-yellow-500" />
                <span className="text-xs font-semibold tracking-tight">Next.js</span>
              </div>
              <div className="flex items-center gap-1.5 rounded-sm bg-muted px-3 py-1.5">
                <Shield className="h-3.5 w-3.5 text-emerald-500" />
                <span className="text-xs font-semibold tracking-tight">Django</span>
              </div>
            </div>
        ...
        <Card className="relative overflow-hidden border-2 hover:border-primary/50 transition-all group">
          ...
          <CardHeader className="pb-4">
            <div className="flex h-14 w-14 items-center justify-center rounded-sm bg-gradient-to-br from-green-500/20 to-teal-500/20 mb-2">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1.5 rounded-sm bg-muted px-3 py-1.5">
                ...
                <span className="text-xs font-semibold tracking-tight">WordPress</span>
              </div>
              <div className="flex items-center gap-1.5 rounded-sm bg-muted px-3 py-1.5">
                <Palette className="h-3.5 w-3.5 text-neutral-900" />
                <span className="text-xs font-semibold tracking-tight">Themes</span>
              </div>
              <div className="flex items-center gap-1.5 rounded-sm bg-muted px-3 py-1.5">
                <Layers className="h-3.5 w-3.5 text-orange-500" />
                <span className="text-xs font-semibold tracking-tight">Plugins</span>
              </div>
              <div className="flex items-center gap-1.5 rounded-sm bg-muted px-3 py-1.5">
                <Zap className="h-3.5 w-3.5 text-yellow-500" />
                <span className="text-xs font-semibold tracking-tight">WooCommerce</span>
              </div>
            </div>
      ...
      <div className="text-center max-w-xl mx-auto pb-8">
        <p className="text-sm text-gray-500">
          ...
          <span className="font-semibold tracking-tight text-foreground">Code Editor</span> gives you full control with any tech stack.{" "}
          <span className="font-semibold tracking-tight text-foreground">WordPress</span> is perfect for quick launches without coding.
