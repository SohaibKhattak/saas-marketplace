...
function DropdownMenuLabel({
  ...
  return (
    <MenuPrimitive.GroupLabel
      ...
      data-inset={inset}
      className={cn(
        "px-1.5 py-1 text-xs font-semibold tracking-tight text-gray-500 data-inset:pl-7",
        className
      )}
      {...props}
    />
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-xs tracking-widest text-gray-500 group-focus/dropdown-menu-item:text-accent-foreground",
        className
      )}
      {...props}
    />
